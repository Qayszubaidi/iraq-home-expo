...
export const metadata: Metadata={title:"Terms & Conditions | Iraq Home Expo 2027",description:"Terms governing use of the Iraq Home Expo website and online visitor, exhibitor and sponsorship enquiry services.",alternates:{canonical:"https://iraqhomeexpo.com/terms"}};
