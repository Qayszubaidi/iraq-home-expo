...
export default function About(){return <><PageHero eyebrow="Iraq Home Expo 2027" title="Connecting the global home industry with opportunities in Iraq" copy="An international exhibition dedicated to products, technologies and solutions for the modern home." image="/assets/hero-about-residential.webp" imageAlt="Modern residential architecture with exterior lighting"/>
