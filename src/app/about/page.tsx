...
export default function About(){return <><PageHero eyebrow="Iraq Home Expo 2027" title="Connecting the global home industry with opportunities in Iraq" copy="An international exhibition dedicated to products, technologies and solutions for the modern home."/>
...
<section className="finalCta"><div><span className="eyebrow">12–15 May 2027 · Baghdad</span><h2>Be part of Iraq Home Expo 2027.</h2></div><div><Link className="button gold" href="/register#visitor">Register to Visit ↗</Link><Link className="button ghost" href="/exhibit">Exhibit with Us ↗</Link></div></section></>}
