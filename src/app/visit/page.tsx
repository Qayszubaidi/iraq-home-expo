...
export default function Visit(){return <><PageHero eyebrow="Visitor Information" title="Visit Iraq Home Expo 2027" copy="Discover products, meet suppliers and connect with companies serving Iraq’s home, interiors and residential markets." image="/assets/visit-hero-new.jpg" imageAlt="Baghdad International Fair at night in Baghdad" imagePosition="bottom center" primary="Register to Visit" primaryHref="/register/visitor"/>
