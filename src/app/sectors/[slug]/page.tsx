...
export async function generateMetadata({params}:{params:Promise<{slug:string}>}){
  ...
  if(!s) return {};
  const title=`${s.title} Exhibition in Iraq | Iraq Home Expo 2027`;
  ...
  return {
    ...
    openGraph:{title,description,url:`https://iraqhomeexpo.com/sectors/${slug}`,type:"website",images:[s.heroImage??s.image]},
  };
}
