...
export const sectors: Sector[] = [
  ...
  { slug:"bathroom-cleaning", title:"Bathroom & Cleaning", short:"Bathroom products, surfaces, laundry and residential and professional cleaning solutions.", image:"/assets/hero-interior.webp", heroImage:"/assets/sector-bathroom-cleaning-hero.webp", categories:["Ceramics, Marble and Porcelain","Bathroom Accessories","Bathroom and Restroom Equipment","Bathroom Furniture","Cleaning Appliances","Cleaning Chemicals","Cleaning Tools and Equipment","Dispensers and Accessories","Floor Mats and Entrance Mats","Laundry Appliances","Laundry Supplies","Personal Protective Equipment","Restroom Supplies","Small Appliances","Specialized Cleaning Equipment"] },
  ...
  { slug:"hvac-r", title:"HVAC + R", short:"Heating, ventilation, air conditioning, refrigeration, filtration and controls.", image:"/assets/hvac.webp", heroImage:"/assets/sector-hvac-r-hero.webp", categories:["Air Filtration and Purification Equipment","Climate Control Appliances","Cooling Equipment","Ductwork and Distribution Components","Heating and Heat Recovery Equipment","Humidification and Dehumidification Equipment","HVAC Controls and Automation Systems","Maintenance and Testing Equipment","Refrigeration Equipment","Thermostats and Temperature Controls","Ventilation Equipment"] },
