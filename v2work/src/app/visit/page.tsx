...
export default function Visit(){return <><PageHero eyebrow="Visitor Information" title="Visit Iraq Home Expo 2027" copy="Discover products, meet suppliers and connect with companies serving Iraq’s home, interiors and residential markets." image="/assets/industry-professionals.webp" primary="Register to Visit" primaryHref="/register/visitor"/>
...
<section className="finalCta"><div><span className="eyebrow">Join us in Baghdad</span><h2>Register to visit Iraq Home Expo 2027.</h2><p>{event.dates} · {event.venue}</p></div><Link className="button gold" href="/register/visitor">Register to Visit ↗</Link></section></>}
